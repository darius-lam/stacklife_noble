    ...
    <div class="container group">
		...
		<div class="row group">
			<div class="span5 offset2 text-padding">		
				...
				<p>Stacklife is not responsible for the privacy practices or content of links to external sites.</p>
					<br />
								
				<span class="question">Information tracked by StackLife</span><br />

				<p>StackLife tracks information on the set of pages a user visits throughout a session and uses that information to display a list of works StackLife users have visited during sessions when they have also visited a particular work's StackLife page. StackLife does not record any personally identifying information about any particular user's path during any session.</p>
        	...
        	<p>(3) StackLife uses a button from AddThis.com that enables the user to post to various social media sites. </p>
			...
			<p>Stacklife is intended for adults and students in high school or beyond. We do not knowingly collect personal information from children under 13 years old. If you are a parent or legal guardian of a child under age 13 who you believe has submitted personal information to Stacklife, please contact us at the address below immediately.</p>
					<br />
			...
			<p>The effective date of this privacy statement is October 22, 2015.</p>
